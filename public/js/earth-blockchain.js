...
function init(){
    ...
    var material = new THREE.PointsMaterial({color: 0x1d1e20, size:2, transparent:true, opacity:0.75});
    star = new THREE.Points(geometry, material);
    scene.add(star);

    var geometry = new THREE.SphereGeometry( 200, 20, 20 );
    var material = new THREE.MeshBasicMaterial( {color: 0x000000, transparent:true, opacity:0.05, wireframe:true} );
